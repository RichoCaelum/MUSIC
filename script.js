...
let songs = [
    {
        ...
        artist: "ABBA",
        album: "Arrival",
        albumArtUrl: "https://imgur.com/zBO9Nrj.jpg",
        audioSrc: "ABBA - Dancing Queen (Official Music Video) (128 KBps).mp3",
        videoBgSrc: "ABBA - Dancing Queen (Official Music Video) (720p).mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
    { time: 21, text: "You can dance, you can jive" },
    { time: 26, text: "Having the time of your life" },
    { time: 31, text: "Ooh, see that girl, watch that scene" },
    { time: 35, text: "Digging the dancing queen" },

    { time: 45, text: "Friday night and the lights are low" },
    { time: 50, text: "Looking out for a place to go" },
    { time: 54, text: "Where they play the right music, getting in the swing" },
    { time: 59, text: "You come to look for a king" },

    { time: 64, text: "Anybody could be that guy" },
    { time: 69, text: "Night is young and the music's high" },
    { time: 74, text: "With a bit of rock music, everything is fine" },
    { time: 78, text: "You're in the mood for a dance" },
    { time: 82, text: "And when you get the chance" },

    { time: 86, text: "You are the dancing queen" },
    { time: 91, text: "Young and sweet, only seventeen" },
    { time: 97, text: "Dancing queen" },
    { time: 100, text: "Feel the beat from the tambourine, oh yeah" },
    { time: 107, text: "You can dance, you can jive" },
    { time: 111, text: "Having the time of your life" },
    { time: 115, text: "Ooh, see that girl, watch that scene" },
    { time: 121, text: "Digging the dancing queen" },

    { time: 136, text: "You're a teaser, you turn 'em on" },
    { time: 140, text: "Leave 'em burning and then you're gone" },
    { time: 145, text: "Looking out for another, anyone will do" },
    { time: 150, text: "You're in the mood for a dance" },
    { time: 153, text: "And when you get the chance" },

    { time: 158, text: "You are the dancing queen" },
    { time: 162, text: "Young and sweet, only seventeen" },
    { time: 169, text: "Dancing queen" },
    { time: 171, text: "Feel the beat from the tambourine, oh yeah" },
    { time: 178, text: "You can dance, you can jive" },
    { time: 183, text: "Having the time of your life" },
    { time: 187, text: "Ooh, see that girl, watch that scene" },
    { time: 193, text: "Digging the dancing queen" },

    { time: 202, text: "Digging the dancing queen" }
]
